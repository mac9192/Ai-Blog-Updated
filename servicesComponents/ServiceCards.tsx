...
<div className='grid   md:mx-auto md:grid-cols-3 sm:grid-cols-1 gap-x-2 gap-y-3 grid-flow-row-dense pt-10   md:pl-[100px] md:pr-[100px]  '>
      ...
      <div className='bg-logoBlue sm:hidden md:block shadow-xl min-h-[350px] row-span-1 md:col-span-2' > 
      <div className=" flex md:flex-row w-full  sm:flex-col  ">
            <div className="flex flex-row   sm:w-full  ">
            <Image className="min-h-[384px]" width={780} height={400} src={carAccident} alt=""/>
            </div>
            <div className="flex flex-col  w-full p-3  "> 
                ...
                <p className="pt-5 text-2xl text-white text-left">FROM BASIC RESEARCH TO PRACTICAL APPLICATIONS</p>
                <p className="w-full text-xl pt-6 text-white">We provide our clients with compassionate, yet aggressive representatio  vehicle accidents.</p>
                <p className="w-full text-xl  text-white pt-5 sm:mb-5">Learn More </p>
            </div>
        </div>
