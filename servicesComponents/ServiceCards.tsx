...
const ServiceCards = () => {
    ...
    return (
      ...
      <p className="md:mt-[400px]  text-3xl tracking-wide w-full border-b-4 border-dotted border-logoBlue text-logoBlue p-3 md:text-left sm:text-center ">Personal Injury Services:</p>
</div>
